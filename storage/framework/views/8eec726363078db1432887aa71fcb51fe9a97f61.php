                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        <?php
                            $counter = 0;
                        ?>
                        <?php $__currentLoopData = $agen->where('role', 2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="<?php echo e(route('agen.restore', $item->id)); ?>"
                                        ...
                                        <button type="submit" class="btn btn-warning btn-sm" title="Restore Admin"
                                            onclick="return confirm(&quot;Apakah anda ingin memulihkan data admin <?php echo e($item->name); ?>?&quot;)"><i
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\ppdb\resources\views/agen/binadmin.blade.php ENDPATH**/ ?>