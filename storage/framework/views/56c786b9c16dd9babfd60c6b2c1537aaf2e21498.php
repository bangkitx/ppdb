...
unset($__errorArgs, $__bag); ?>
                            ...
                            <tr>
                                ...
                                <td colspan="2"><input type="name" id="kuotap" name="kuotap"
                                   aria-label="kuotap" class="form-control" value="<?php echo e($config->kuotap); ?>" pattern="^[0-9]+$"></td>
                               </tr>
                               <tr>
                                <td>Kuota Pendaftaran Laki-Laki</td>
                                <td colspan="2"><input type="name" id="kuotal" name="kuotal"
                                   aria-label="kuotal" class="form-control" value="<?php echo e($config->kuotal); ?>" pattern="^[0-9]+$"></td>
                               </tr>
                        <tr>
                            <td>Kelulusan</td>
                            <td>
