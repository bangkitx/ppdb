...
unset($__errorArgs, $__bag); ?>"
                                                ...
                                                <option value="1"
                                                    <?php echo e(old('penghasilan_ayah') == '<1Juta' ? 'selected' : ''); ?>>Di bawah Rp
                                                    1.000.000</option>
                                                <option value="2"
                                                    <?php echo e(old('penghasilan_ayah') == '1Juta-3Juta' ? 'selected' : ''); ?>>Rp 1.000.000 -
                                                    Rp 3.000.000</option>
                                                <option value="3"
                                                    <?php echo e(old('penghasilan_ayah') == '3Juta-5Juta' ? 'selected' : ''); ?>>Rp 3.000.000 -
                                                    Rp 5.000.000</option>
                                                <option value="4"
                                                    <?php echo e(old('penghasilan_ayah') == '5Juta-10Juta' ? 'selected' : ''); ?>>Rp 5.000.000 -
                                                    Rp 10.000.000</option>
                                                <option value="5"
                                                    <?php echo e(old('penghasilan_ayah') == '>10Juta' ? 'selected' : ''); ?>>Di atas Rp
                                                    10.000.000</option>
...
unset($__errorArgs, $__bag); ?>"
                                                ...
                                                <option value="1"
                                                    <?php echo e(old('penghasilan_ibu') == '<1Juta' ? 'selected' : ''); ?>>Di bawah Rp
                                                    1.000.000</option>
                                                <option value="2"
                                                    <?php echo e(old('penghasilan_ibu') == '1Juta-3Juta' ? 'selected' : ''); ?>>Rp 1.000.000 - Rp
                                                    3.000.000</option>
                                                <option value="3"
                                                    <?php echo e(old('penghasilan_ibu') == '3Juta-5Juta' ? 'selected' : ''); ?>>Rp 3.000.000 - Rp
                                                    5.000.000</option>
                                                <option value="4"
                                                    <?php echo e(old('penghasilan_ibu') == '5Juta-10Juta' ? 'selected' : ''); ?>>Rp 5.000.000 - Rp
                                                    10.000.000</option>
                                                <option value="5"
                                                    <?php echo e(old('penghasilan_ibu') == '>10Juta' ? 'selected' : ''); ?>>Di atas Rp
                                                    10.000.000</option>
                                                <!-- Add other options as needed -->
                                            </select>
...
unset($__errorArgs, $__bag); ?>"
                                                ...
                                                <option value="1"
                                                    <?php echo e(old('penghasilan_wali') == '<1Juta' ? 'selected' : ''); ?>>Di bawah Rp
                                                    1.000.000</option>
                                                <option value="2"
                                                    <?php echo e(old('penghasilan_wali') == '1Juta-3Juta' ? 'selected' : ''); ?>>Rp 1.000.000 -
                                                    Rp 3.000.000</option>
                                                <option value="3"
                                                    <?php echo e(old('penghasilan_wali') == '3Juta-5Juta' ? 'selected' : ''); ?>>Rp 3.000.000 -
                                                    Rp 5.000.000</option>
                                                <option value="4"
                                                    <?php echo e(old('penghasilan_wali') == '5Juta-10Juta' ? 'selected' : ''); ?>>Rp 5.000.000 -
                                                    Rp 10.000.000</option>
                                                <option value="5"
                                                    <?php echo e(old('penghasilan_wali') == '>10Juta' ? 'selected' : ''); ?>>Di atas Rp
                                                    10.000.000</option>
                                                <!-- Add other options as needed -->
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group form-outline">
                                            <input type="checkbox" name="paid" id="paid"
                                                <?php if(old('paid')): ?> checked <?php endif; ?>>
                                            <label for="paid" class="form-label">
                                                Siswa telah membayar uang pendaftaran?
                                            </label>
                                            <?php $__errorArgs = ['pendidikan_terakir_wali'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\ppdb\resources\views/agen/create.blade.php ENDPATH**/ ?>