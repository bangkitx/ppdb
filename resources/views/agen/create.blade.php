                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group form-outline">
                                            <select id="penghasilan_ayah"
                                                ...
                                                <option value="1"
                                                    {{ old('penghasilan_ayah') == '<1Juta' ? 'selected' : '' }}>Di bawah Rp
                                                    1.000.000</option>
                                                <option value="2"
                                                    {{ old('penghasilan_ayah') == '1Juta-3Juta' ? 'selected' : '' }}>Rp 1.000.000 -
                                                    Rp 3.000.000</option>
                                                <option value="3"
                                                    {{ old('penghasilan_ayah') == '3Juta-5Juta' ? 'selected' : '' }}>Rp 3.000.000 -
                                                    Rp 5.000.000</option>
                                                <option value="4"
                                                    {{ old('penghasilan_ayah') == '5Juta-10Juta' ? 'selected' : '' }}>Rp 5.000.000 -
                                                    Rp 10.000.000</option>
                                                <option value="5"
                                                    {{ old('penghasilan_ayah') == '>10Juta' ? 'selected' : '' }}>Di atas Rp
                                                    10.000.000</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group form-outline">
                                            <select id="penghasilan_ibu"
                                                ...
                                                <option value="1"
                                                    {{ old('penghasilan_ibu') == '<1Juta' ? 'selected' : '' }}>Di bawah Rp
                                                    1.000.000</option>
                                                <option value="2"
                                                    {{ old('penghasilan_ibu') == '1Juta-3Juta' ? 'selected' : '' }}>Rp 1.000.000 - Rp
                                                    3.000.000</option>
                                                <option value="3"
                                                    {{ old('penghasilan_ibu') == '3Juta-5Juta' ? 'selected' : '' }}>Rp 3.000.000 - Rp
                                                    5.000.000</option>
                                                <option value="4"
                                                    {{ old('penghasilan_ibu') == '5Juta-10Juta' ? 'selected' : '' }}>Rp 5.000.000 - Rp
                                                    10.000.000</option>
                                                <option value="5"
                                                    {{ old('penghasilan_ibu') == '>10Juta' ? 'selected' : '' }}>Di atas Rp
                                                    10.000.000</option>
                                                <!-- Add other options as needed -->
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group form-outline">
                                            <select id="penghasilan_wali"
                                                ...
                                                <option value="1"
                                                    {{ old('penghasilan_wali') == '<1Juta' ? 'selected' : '' }}>Di bawah Rp
                                                    1.000.000</option>
                                                <option value="2"
                                                    {{ old('penghasilan_wali') == '1Juta-3Juta' ? 'selected' : '' }}>Rp 1.000.000 -
                                                    Rp 3.000.000</option>
                                                <option value="3"
                                                    {{ old('penghasilan_wali') == '3Juta-5Juta' ? 'selected' : '' }}>Rp 3.000.000 -
                                                    Rp 5.000.000</option>
                                                <option value="4"
                                                    {{ old('penghasilan_wali') == '5Juta-10Juta' ? 'selected' : '' }}>Rp 5.000.000 -
                                                    Rp 10.000.000</option>
                                                <option value="5"
                                                    {{ old('penghasilan_wali') == '>10Juta' ? 'selected' : '' }}>Di atas Rp
                                                    10.000.000</option>
                                                <!-- Add other options as needed -->
                                            </select>
