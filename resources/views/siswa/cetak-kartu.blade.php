    ...
    <div class="halaman">
        <header>
            ...
            <h1 id=judul>TAHUN PELAJARAN
                {{ \Carbon\Carbon::now()->format('Y') }}/{{ \Carbon\Carbon::now()->addYear()->format('Y') }}</h1>
        </header>

        <div class="container">
            <h2 style="text-align: center; ">Nomor Peserta : </h2>
            <h1 style="text-align: center; ">{{ $data->nomor_peserta }}</h1>
            ...
            <div class="data-diri">
                <table style="flex: 1 1 auto; ">
                    ...
                    <tr style="width: 100%">
                        ...
                        <td style="width: 5%;">:</td>
                        <td style="width: 65%;">{{ $data->asal_sekolah }}</td>
                    </tr>
                </table>

                <div class="image-container">
                    <img src="{{ asset($avatar) }}" alt="FOTO">
                </div>
